...
<img src="./public/assets/img/burger4.jpg">
...
<pre>
  git clone https://github.com/docvvk/burger.git
  cd burger
</pre>
...
<li>
  ...
  INSERT INTO burgers (burger_name, devoured) VALUES ("Tikka Burger", false);

  INSERT INTO burgers (burger_name, devoured) VALUES ("Special Punjabi Burger", true);
  </pre>
...
<p>If you find an issue while using the app or have a request, <a href="https://github.com/doccvvk/burger/issues/" target="_blank">log the issue or request here</a>. These issues will be addressed in a future code update.</p>